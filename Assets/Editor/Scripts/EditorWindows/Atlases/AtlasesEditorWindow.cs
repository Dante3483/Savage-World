...
namespace SavageWorld.Editor.EditorWindows.Atlases
{
            ...
            if (isAnyItemSelected)
            {
                ...
                if (count > 1)
                {
                    ...
                    Object[] objects = selectedItems
                        ...
                        .Select(obj => obj.Data)
                        .ToArray();
                    editor = UnityEditor.Editor.CreateEditor(objects);
                }
                else
                {
                    editor = UnityEditor.Editor.CreateEditor(_currentObject.Data);
                }
